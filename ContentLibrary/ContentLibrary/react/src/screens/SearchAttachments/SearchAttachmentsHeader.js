...
import { SegmentedControl } from 'apollo-react-native';
...
const SearchAttachmentsHeader = ({ navigation }) => {
    ...
    const segmentTextStyles = (ownership) => {
        return Platform.isPad ? {
            ...styles.segmentText,
            color: ownershipFilter === ownership ? '#fff' : '#000'
        } : {
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.backContainer} onPress={handleBackButton} testID="headerBackButton">
                <>
                    <Icon name="chevron-left" size={40} style={styles.backIcon} />
                    {Platform.isPad && <Text style={styles.text}>Back</Text>}
                </>
            </TouchableOpacity>
            ...
            {!Platform.isPad && (
                <TouchableWithoutFeedback testID="openSearchButton" onPress={() => {
                    ...
                    <Icon name="magnify" size={30} style={styles.backIcon} />
            ...
            <View style={Platform.isPad ? { position: 'relative' } : inputMobileWrapperStyles}>
                <TextInput
                    ...
                    style={Platform.isPad ? styles.searchBar : inputMobileStyles} />
