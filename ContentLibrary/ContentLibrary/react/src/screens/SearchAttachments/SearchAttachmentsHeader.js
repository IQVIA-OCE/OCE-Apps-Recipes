...
const isPadOrWeb = Platform.isPad || Platform.OS === 'web';
...
const SearchAttachmentsHeader = () => {
    ...
    const segmentControlStyles = isPadOrWeb ? styles.segmentControl : styles.segmentControlMobile;
    const segmentTextWrapperStyles = isPadOrWeb ? styles.segmentViewItem : styles.segmentViewItemMobile;
        ...
        <View style={[styles.container, {backgroundColor: theme.colors.background, borderColor: borderColor}]}>
            ...
            >
                <SegmentedControl
                    ...
                    value={OWNED_BY_ME}
                    children={
                        <View style={[segmentTextWrapperStyles, Platform.OS === 'web' && styles.segmentWrapperStyleWeb]}>
            ...
            {!Platform.isPad && Platform.OS !== 'web' && (
