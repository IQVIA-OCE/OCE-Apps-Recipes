...
import {environment, externalNavigator, navigator} from '@oce-apps/oce-apps-bridges';
...
class StackedBarChartCallDetails extends React.Component {
  ...
  fetchCalldata = async () => {
    ...
    try {
      ...
      Object.keys(callDataByType).forEach(callType => {
        ...
        <View
          style={[
            styles.topButtons,
            {
              ...
              top: isMobilePhone ? 0 : -65,
              width: isMobilePhone ? '100%' : 250,
              right: isMobilePhone ? 20 : 0,
            },
          ]}
        >
          ...
          <React.Fragment>
            <ScrollView horizontal testID="chart-container">
              <BarChart
                ...
                colorScale={isMobilePhone ? chartColors : colorScale}
                height={250}
                allowZoom={false}
                allowPan={false}
                zoomDimension="x"
                ...
                tickCount={isMobilePhone ? null : 12}
                hasAxis={true}
                fixLabelOverlap
              />
            </ScrollView>
