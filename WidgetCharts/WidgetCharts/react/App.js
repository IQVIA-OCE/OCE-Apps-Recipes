...
import { Provider, SegmentedControl, DarkTheme, DefaultTheme, Card } from '@oce-apps/apollo-react-native';
import { StyleSheet, ScrollView, useColorScheme, Platform, Text } from 'react-native';

import { isMobilePhone } from './src/constants';
import { layoutBridge, reachability } from '@oce-apps/oce-apps-bridges';
