...
export const fetchRemoteCallsForToday = (accountId) => {
  ...
  return databaseManager.fetch(`SELECT Id, Name, ${NAMESPACE}Account__c, ${NAMESPACE}Account__r.Name, ${NAMESPACE}EndCallDateTime__c, ${NAMESPACE}LocationName__c, ${NAMESPACE}AccountName__c, ${NAMESPACE}Status__c, ${NAMESPACE}Duration__c, ${NAMESPACE}CallDateTime__c\
