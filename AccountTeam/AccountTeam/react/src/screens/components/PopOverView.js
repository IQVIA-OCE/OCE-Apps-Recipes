...
export const PopOverView = () => {
    ...
    return (
        <View testID={'popOverView'} style={[styles.container, { right, maxHeight, top: (Platform.OS === 'web' && activeIndex == 0) ? infoContainerTopPosition + 20 : infoContainerTopPosition, maxWidth: isIphone ? popupiPhoneWidth : 400 }]} ref={detailContainerRef}>
