...
export const mapReport = (reports) =>
  reports.map((el) => ({
    ...
    callLocation: el[`${NAMESPACE}CallSampleOrder__r`][`${NAMESPACE}Call__r`][`${NAMESPACE}Location__r`] ? el[`${NAMESPACE}CallSampleOrder__r`][`${NAMESPACE}Call__r`][`${NAMESPACE}Location__r`][`${NAMESPACE}City__c`] : '',
