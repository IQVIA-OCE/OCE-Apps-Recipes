...
import { Loader, Title, themeGrey, Modal, Banner, useTheme, ApolloProgress } from 'apollo-react-native';
import { View, ScrollView, StyleSheet, NativeModules, Alert } from 'react-native';
import { useDispatch, useSelector } from 'react-redux';
import color from 'color'
import { locationManager, externalNavigator, environment } from 'oce-apps-bridges';
