...
import { Search, Menu, ApolloProgress } from 'apollo-react-native';
import { fetchAccounts } from './../../api/OrderDetails';
import { localized, environment } from 'oce-apps-bridges';
import { setRecordId, setOrderDeliveries } from '../../stores/orders';
...
const AccountsFilter = () => {
  ...
  return (
    ...
    >
      {isListLoading && (
        <View style={styles.listLoader} testID="loading">
          <ApolloProgress />
        </View>
      )}
