...
describe('commonApi', () => {
  ...
  describe('checkConditionsPassed', () => {
    it('should return true if all conditions pass (single value)', () => {
      const conditions = [
        {
          OCE__Field__c: 'OCE__Status__c',
          OCE__Operator__c: 'EQUALS',
      ...
      const conditionsPassed = commonApi.checkConditionsPassed(conditions, object);

      expect(conditionsPassed).toBe(true);
    });

    it('should return true if all conditions pass (multiple values)', () => {
      const conditions = [
        {
          OCE__Field__c: 'RecordType.DeveloperName',
          OCE__Operator__c: 'IN',
    ...
    it('should return false if some condition does not pass', () => {
      const conditions = [
        {
          OCE__Field__c: 'OCE__Status__c',
          OCE__Operator__c: 'EQUALS',
