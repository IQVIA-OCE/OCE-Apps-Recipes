...
class SFNetAPI {
    apiVersion = environment.sfApiVersion();
    ...
    */
    upsert(
        ...
        this.sendRequest(
            "/services/data",
            `/${this
                .apiVersion}/sobjects/${objtype}/${externalIdField}/${externalId}`,
            callback,
            error,
    ...
    * @param [error=null] function called in case of error
    */
    query(soql: string, callback: SuccessCallback, error: ErrorCallback) {
        this.sendRequest(
            "/services/data",
    ...
    * @param [error=null] function called in case of error
    */
    queryMore(url: string, callback: SuccessCallback, error: ErrorCallback) {
        // $FlowIgnore
        const pathFromUrl = url.match(/https:\/\/[^/]*(.*)/)[1];
        return this.sendRequest("", pathFromUrl, callback, error);
    }
    ...
    * @param [error=null] function called in case of error
    */
    search(sosl: string, callback: SuccessCallback, error: ErrorCallback) {
        this.sendRequest(
            "/services/data",
    ...
    */
    ...
    report(reportId: string, callback: SuccessCallback, error: ErrorCallback) {
        this.sendRequest(
            "/services/data",
