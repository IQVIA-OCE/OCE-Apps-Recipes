import { groupBy, mapCountries, mapPicklist, mapWorkplaceFormValues, mapActivityFormValues, mapWorkplaces, submitOneKeyRequest } from './utils';
...
describe('utils', () => {
  ...
  it('should call submitOneKeyRequest with resolve', async () => {
    global.fetch = jest.fn(() => Promise.resolve({
        json: () => Promise.resolve({}),
      })
    );
    await expect(submitOneKeyRequest({}, 'url')).resolves.not.toThrow();
  })
  it('should call submitOneKeyRequest with reject', async () => {
    await expect(submitOneKeyRequest({})).rejects.toBeFalsy();
  })
});
