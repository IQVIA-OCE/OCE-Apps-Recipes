...
import { StyleSheet, SafeAreaView, ScrollView, View, Text, Platform, useColorScheme } from 'react-native';
    ...
    return new Promise((resolve, reject) => {
      sfNetAPI
        .create(`QIDC__Validation_Request_ims__c`, {
            ...
            QIDC__Country_ISO_Code_ims__c: requestData['address.country']?.value,
          },
          data => {
            console.log(data);
            this.setState({showRequestSubmittedMessage: true});
