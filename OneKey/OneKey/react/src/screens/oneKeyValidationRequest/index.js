...
import { Button, ActivityIndicator, Banner, Select, DefaultTheme, DarkTheme, withTheme } from '@oce-apps/apollo-react-native';
...
class OneKeyValidationRequest extends React.Component {
  ...
  getInitialValues = (initialData) => {
    ...
    return {
      ...
      address: {
        country: '',
        longLabel: initialData['OCE__PrimaryAccountAddress__r']? initialData['OCE__PrimaryAccountAddress__r']['OCE__AddressLine1__c'] : '',
        city: initialData['OCE__PrimaryAccountAddress__r'] ? initialData['OCE__PrimaryAccountAddress__r']['OCE__City__c'] : '',
        longPostalCode: initialData['OCE__PrimaryAccountAddress__r'] ? initialData['OCE__PrimaryAccountAddress__r']['OCE__ZipCode__c'] : '',
        countyCode: '',
      },
      workplace: {
        workplaceEid: '',
        usualName: initialData.Name || '',
        parentUsualName: '',
    ...
    return Yup.object().shape({
        ...
        workplace: Yup.object().shape({
          ...
          typeCode: Yup.object().shape({
            value: Yup
              .string(),
          }).nullable().test('required', 'Required', function(value) {
