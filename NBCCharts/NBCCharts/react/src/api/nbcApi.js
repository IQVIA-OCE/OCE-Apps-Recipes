...
export const fetchNbcData = ({
  ...
  const query = `SELECT ${defaultCols} ${cols} FROM OCE__NextBestCustomer__c ${filter} ORDER BY ${sortColumn.accessor} ${sortDirection} NULLS LAST LIMIT ${limit} OFFSET ${offset}`;
