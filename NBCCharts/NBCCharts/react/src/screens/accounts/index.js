...
export default class AccountsScreen extends React.Component {
    ...
    fetchData(filterQuery, limit, offset) {
        ...
        const defaultCols = "Id, OCE__Account__r.Id, OCE__Account__r.Name, OCE__Account__r.OCE__CountryCode__c, OCE__Account__r.OCE__PrimaryAccountAddress__r.OCE__Address__r.OCE__DisplayAddress__c, OCE__NbcData__c, OCE__TotalScore__c, OCE__Account__r.OCE__Specialty__c, OCE__Account__r.OCE__ParentAccount__r.Name,";
