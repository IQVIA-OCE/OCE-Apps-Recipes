...
import { environment, layoutBridge, sfNetAPI } from "oce-apps-bridges";
import {
  fetchAccountName,
  setAccountId,
  setError,
...
import { Provider as ApolloProvider, DarkTheme, DefaultTheme, useTheme } from 'apollo-react-native';
