...
import { Provider, DonutChart, Menu, useTheme } from '@oce-apps/apollo-react-native';
                        ...
                        <View style={styles.row}>
                            ...
                            <View style={styles.infoContainer}>
                                <Provider theme={colorScheme}>
                                    <TouchableOpacity onPress={showMenu} onLayout={setLayout} style={styles.infoButton}>
                                        <View style={styles.row}>
