...
import { Provider, DonutChart, Menu, Headline } from 'apollo-react-native';


const DonutChartContainer = ({ selectedProduct, shouldMenuClose }) => {
                        ...
                        <View style={styles.row}>
                            <View style={styles.donutChartContainer}>
                                <DonutChart
                                    ...
                                    data={[{ name: 'Disbursed', value: value, tooltip: disbursed }]}
                                />
                                <View style={{ flexDirection: 'row', paddingTop: 30 }}>
                                    <View style={styles.rowCenter}>
                                        <View style={[styles.indicator, { backgroundColor: '#4ba9c8' }]}></View>
                                        <Text>Disbursed</Text>
                                    </View>
                                    <View style={styles.rowCenter}>
                                        <View style={[styles.indicator, { backgroundColor: '#f3f3f3' }]}></View>
                                        <Text>Remaining</Text>
                                    </View>
                                </View>
                            </View>
