...
import { Divider, Autocomplete, useTheme, ApolloProgress } from 'apollo-react-native';
...
const SampleLimitWidget = ({ colorScheme, accountId }) => {
    ...
    const fetchProductData = async () => {
        try {
            ...
            const filterdProducts = mapAccountProducts(products);
    ...
    const fetchAccountData = async () => {
        try {
            ...
            const filteredAccounts = mapAccounts(accounts);
