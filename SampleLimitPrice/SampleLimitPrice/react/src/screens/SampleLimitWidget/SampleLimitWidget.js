...
import { Divider, Headline, Title, Autocomplete } from 'apollo-react-native';
...
const SampleLimitWidget = ({ accountId }) => {
    ...
    return (
        <TouchableWithoutFeedback style={{ flex: 1 }} onPress={() => dismissAutoComplete(false)}>
            <View style={styles.container}>
                ...
                <DonutChartContainer selectedProduct={selectedProduct} shouldMenuClose={shouldMenuClose} />
            </View>
