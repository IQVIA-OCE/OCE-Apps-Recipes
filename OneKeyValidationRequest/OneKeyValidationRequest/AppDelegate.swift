...
final class OCEAppDelegate: AppDelegate {
    ...
    override func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        _ = ReactProvider.default.addObserver { _ in
            guard let topViewController = UIApplication.shared.topViewControllerInTopVisibleWindow() else {
            ...
            let reactAppCoordinator = ReactAppCoordinator(presenter: topViewController, bundleURL: url)
