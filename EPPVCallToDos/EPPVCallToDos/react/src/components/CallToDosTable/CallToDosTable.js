...
import { ApolloProgress, Button, Portal, Table, useTheme } from 'apollo-react-native';
      ...
      <Table
        ...
        CustomHeader={() => (
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Button onPress={() => handleOpenModal(null)} icon="plus" mode="contained" testID="new-button">
              New
            </Button>
          </View>
        )}
