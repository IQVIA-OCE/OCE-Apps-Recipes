import { RadioButton, Text, useTheme } from '@oce-apps/apollo-react-native';
...
import { isMobilePhone } from '../../helpers';
import {
  ADD_ACCOUNT_TYPE,
  REMOVE_ACCOUNT_TYPE,
...
const NewActivityPlanChangeRequest = () => {
    ...
    >
      ...
      <View style={styles.sectionWrapper}>
        ...
        <View
          ...
          testID="ActivityTypeRadioButton"
        >
          <RadioButton.Group
...
export default NewActivityPlanChangeRequest;
