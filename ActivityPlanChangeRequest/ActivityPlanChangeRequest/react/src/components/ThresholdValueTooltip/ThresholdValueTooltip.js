import { LinearProgress, useTheme } from '@oce-apps/apollo-react-native';
...
const ThresholdValueTooltip = ({ extended }) => {
  ...
  if (extended) {
    return (
      <View style={styles.containerExtended}>
        <Text style={[styles.titleExtended, { color: theme.colors.text }]}>Threshold Value</Text>
  ...
  return (
    <View style={styles.container}>
      <Text style={[styles.title, { color: theme.colors.text }]}>Threshold Value</Text>
