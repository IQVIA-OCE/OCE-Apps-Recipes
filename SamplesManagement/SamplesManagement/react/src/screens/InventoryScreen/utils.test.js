...
describe('utils', () => {
  it('getConfig: should return a proper config', () => {
    let config = getConfig([{ ownerId: 3 }, { ownerId: 2 }], [1, 2, 3]);

    expect(config).toStrictEqual({ ownerId: 2 });

    config = getConfig([{ ownerId: 3 }, { ownerId: 2 }]);
