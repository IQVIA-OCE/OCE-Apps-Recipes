...
import { Loader } from '@oce-apps/apollo-react-native';
...
describe('InventoryScreenComponent', () => {
  ...
  it('Should trigger submit', async () => {
    ...
    await act(
      async () => await UNSAFE_root.findByType(Formik).props.onSubmit({}, {})
    );
    ...
    act(() => {
      UNSAFE_root.findByType(Formik).props.validationSchema();
    });
