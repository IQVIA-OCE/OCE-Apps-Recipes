...
export const configKeys = {
  ...
  oce__soenableproductallocation__c: 'enableProductAllocation',
  oce__soproductquantitylimit__c: 'orderCheck',
  oce__sofinalstatus__c: 'finalStatus',
  oce__soshowproductallocationremaining__c: 'showProductAllocationRemaining'
};
