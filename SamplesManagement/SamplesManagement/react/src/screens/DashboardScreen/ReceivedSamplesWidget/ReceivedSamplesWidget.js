        ...
        <Card.Content>
          {isLoading ? (
            ...
            <Tabs defaultActiveIndex={1}>
              ...
              <Tabs.Container>
                <Tabs.Item>
                  <TimelineComponent items={allReceivedSamplesList} navigation={navigation}/>
                ...
                <Tabs.Item>
                  <TimelineComponent items={acknowledgementOfShipmentList} navigation={navigation}/>
                </Tabs.Item>
                <Tabs.Item>
                  <TimelineComponent items={transferInList} navigation={navigation}/>
                </Tabs.Item>
              </Tabs.Container>
            </Tabs>
          )}
...
export default withTheme(ReceivedSamplesWidget);
