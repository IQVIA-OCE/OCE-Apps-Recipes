...
const mapAOSFormDetails = values => ({
  ...
  OCE__TransactionRepTerritory__c: values.fields.transactionRepTerritory.name,
...
const mapTransferInFormDetails = values => ({
  ...
  OCE__ToSalesRepTerritory__c: values.fields.toSalesRepTerritory.name,
  OCE__FromSalesRep__c: values.fields.fromSalesRep.value,
  OCE__FromSalesRepTerritory__c: values.fields.fromSalesRepTerritory.name,
...
export const mapTransactionDetails = transactionsData => {
  const transactionDetails = transactionsData.map(sampleTransaction => {
    ...
    return {
      ...
      territory: { name: sampleTransaction.OCE__TransactionRepTerritory__c },
      shipTo: {
      ...
      toSalesRepTerritory: {
        name: sampleTransaction.OCE__ToSalesRepTerritory__c,
      },
      fromSalesRepTerritory: {
        name: sampleTransaction.OCE__FromSalesRepTerritory__c,
      },
      transactionRepTerritory: {
        name: sampleTransaction.OCE__TransactionRepTerritory__c,
      },
    };
  });
