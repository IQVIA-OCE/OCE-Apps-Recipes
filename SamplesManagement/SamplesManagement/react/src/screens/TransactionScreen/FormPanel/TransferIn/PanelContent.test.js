...
describe('PanelHeader', () => {
  ...
  it('should render properly', async () => {
    ...
    await act(() => container.findAllByType(Select)[1].props.onChange());

    expect(container.findByType(Autocomplete)).toBeTruthy();
  });
  ...
  it('should render in readonly mode properly', async () => {
    ...
    expect(container.findAllByType(Autocomplete).length).toEqual(0);
  });
});
