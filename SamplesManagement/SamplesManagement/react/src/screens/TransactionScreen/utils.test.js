    ...
    let normalized = mapTransactionDetails([
      {
        ...
        OCE__ShipmentCarrier__c: 'ShCarrier',
        OCE__FromSalesRep__c: 'OCE__FromSalesRep__c',
        OCE__TransactionRep__c: 'OCE__TransactionRep__c',
        OCE__TransactionRepTerritory__c: 'TerrritoryName',
        OCE__TrackingNumber__c: 'OCE__TrackingNumber__c',
        OCE__Comments__c: 'OCE__Comments__c',
        RecordTypeId: 'RecordTypeId',
        OCE__ToSalesRepTerritory__c: 'OCE__ToSalesRepTerritory__c',
        OCE__FromSalesRepTerritory__c: 'OCE__FromSalesRepTerritory__c',
        OCE__TransactionRepTerritory__c: 'OCE__TransactionRepTerritory__c'
      },
    ]);
    expect(normalized).toStrictEqual({
      accountId: null,
      ...
      detailsCount: 0,
      fromSalesRep: { label: null, value: 'OCE__FromSalesRep__c' },
      fromSalesRepId: 'OCE__FromSalesRep__c',
      ...
      territory: { name: 'OCE__TransactionRepTerritory__c' },
      toSalesRep: { label: null, value: undefined },
      toSalesRepId: undefined,
      toSalesRepName: null,
      trackingNumber: 'OCE__TrackingNumber__c',
      transactionDateTime: undefined,
      transactionRepId: 'OCE__TransactionRep__c',
      transactionRepName: null,
      fromSalesRepTerritory: {
        name: 'OCE__FromSalesRepTerritory__c'
      },
      toSalesRepTerritory: {
        name: 'OCE__ToSalesRepTerritory__c'
      },
      transactionRepTerritory: {
        name: 'OCE__TransactionRepTerritory__c'
      }
    });
  });
});
