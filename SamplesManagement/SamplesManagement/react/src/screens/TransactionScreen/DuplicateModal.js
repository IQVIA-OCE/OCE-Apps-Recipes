...
import { Modal, Button, TextInput, Text } from '@oce-apps/apollo-react-native';
      ...
      <Formik
        ...
        validationSchema={Yup.object().shape({
          fields: Yup.object().shape({
            comments: Yup.string().nullable().required('Complete this field.'),
          }),
        })}
      >
          ...
          <>
            ...
            <Modal.Content>
              ...
              <TextInput
                ...
                required
                fullWidth
                helperText={getFieldHelperText('comments', errors, touched)}
