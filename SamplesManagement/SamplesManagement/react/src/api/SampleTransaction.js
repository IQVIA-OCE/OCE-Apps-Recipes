...
export const fetchTransactionDetails = transactionId =>
  transactionId
    ? api.query(
        ...
        OCE__TransactionRep__c,OCE__Zip__c,OwnerId,RecordTypeId,RecordType.Name, RecordType.DeveloperName FROM OCE__SampleTransaction__c WHERE Id = '${transactionId}'`
      )
    : Promise.resolve([]);
