...
import { ApolloProgress, Checkbox, Portal, Table, useTheme } from '@oce-apps/apollo-react-native';
...
import { isMobilePhone, isWeb } from '../../utils';
import { actionsColumn, CheckboxCell, columnsTablet, columnsPhone, DetailRow, expandColumn } from './columns';
...
export const ApprovalRequestsTable = () => {
  ...
  const selectionColumn = {
    header: (
      <View
        style={[isWeb && { position: 'relative', top: -6 }]}
  ...
  const columns = [
    ...
    ...(isMobilePhone ? columnsPhone : columnsTablet),
