...
describe('ApprovalRequestsHeader', () => {
  ...
  describe('(iPad) ', () => {
    ...
    it('should render properly', () => {
      ...
      expect(getByTestId('ipad-actions')).toBeTruthy();
    });
    ...
    it('should not render actions if status is not "Pending"', () => {
      ...
      expect(queryByTestId('ipad-actions')).toBeNull();
    });
  ...
  describe('(iPhone) ', () => {
    ...
    it('should render properly', () => {
      ...
      expect(getByTestId('status-select')).toBeTruthy();
      expect(getByTestId('iphone-actions')).toBeTruthy();
    });
    ...
    it('should not render actions if status is not "Pending"', () => {
      ...
      expect(queryByTestId('iphone-actions')).toBeNull();
    });
